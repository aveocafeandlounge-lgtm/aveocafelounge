      ...
      <html>
        ...
        <body>
          ...
          <div class="section" style="margin-top: 20px; text-align: center; border-top: 2px solid #000; padding-top: 10px;">
            <p>End of Report</p>
            <p>Generated by AVEO CAFE' & LOUNGE POS</p>
          </div>
                    ...
                    <div className="bg-white p-4 rounded-lg mb-4 font-mono text-xs border border-slate-300" id="print-bill">
                      <div className="flex justify-between items-center mb-4">
                        <div className="flex-0">
                          <img src="/logo.jpg" alt="Aveo Cafe' & Lounge" className="h-12 w-12 rounded-full" />
                        </div>
                        <div className="flex-1 text-center">
                          <h4 className="font-bold text-sm">Aveo Cafe' & Lounge</h4>
